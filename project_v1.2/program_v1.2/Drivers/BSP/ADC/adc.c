...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    if(hadc->Instance == ADC_ADC1)
    {
        ...
        ADC_ADC1_CH8_CLK_ENABLE();                                /* 使能ADCx时钟 */
        ADC_ADC1_CH8_GPIO_CLK_ENABLE();                           /* 开启GPIO时钟 */
        ...
        /* 设置AD采集通道对应IO引脚工作模式 */
        gpio_init_struct.Pin = ADC_ADC1_CH8_GPIO_PIN;             /* ADC通道IO引脚 */
        gpio_init_struct.Mode = GPIO_MODE_ANALOG;                 /* 模拟 */
        HAL_GPIO_Init(ADC_ADC1_CH8_GPIO_PORT, &gpio_init_struct);
    }
}
